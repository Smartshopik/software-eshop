...
class InputNumber extends Component {
  ...
  handleEvent(instance: InputNumberInstance) {
    ...
    buttons[0].addEventListener('click', (e) => this.handleIncrease(e, instance))
    buttons[1].addEventListener('click', (e) => this.handleDecrease(e, instance))
    instance.faker.querySelector('input').addEventListener('change', (e) => this.handleChange(e, instance))
  }
